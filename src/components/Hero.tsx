			...
			<div className="grid max-w-screen-xl px-4 py-2 pb-4 md:py-8 mx-auto md:gap-8 lg:pb-12 lg:px-16 md:grid-cols-12">
				<div className="hero-left place-self-center md:col-span-7">
					...
					<a
						...
						className="bg-green-medium inline-flex items-center justify-center px-4 sm:px-7 py-3 mr-3 text-base font-medium text-center text-white rounded-lg focus:ring-4 focus:ring-primary-300 hover:shadow-md ">
						03 88 87 15 15
					</a>
					<a
						href="contact"
