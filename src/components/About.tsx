...
const About: React.FC = () => {
	...
	return (
		<div className="about py-4 lg:px-16 bg-[#FAFCE5]">
			<h1 className="text-4xl font-extrabold text-center text-black pb-3 pt-8">
				{about.title}
			</h1>
			...
			{about.items.map((paragraph, index) => (
				<div
					key={index}
					className="about-paragraph grid max-w-screen-xl px-4 py-2 mx-auto md:gap-8 xl:gap-0 lg:py-8 md:grid-cols-12">
					<div
						className={`about-desc  mr-auto place-self-center md:col-span-7 px-4 ${
